...
\t\t\t\t\t\t\t\t<object type=\"none/none\">";
            // line 437
            echo Twig_SupTwgSgg_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["photo"] ?? null), "attachment", array()), "caption", array()), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t</object>
\t\t\t\t\t\t\t</div>";
        }
...
\t\t\t\t</FIGCAPTION>";
    ...
    {
        return new Twig_SupTwgSgg_Source("", "@galleries/shortcode/helpers.twig", "/Applications/MAMP/htdocs/Hexing/wp-content/plugins/gallery-by-supsystic/src/GridGallery/Galleries/views/shortcode/helpers.twig");
    }
}
