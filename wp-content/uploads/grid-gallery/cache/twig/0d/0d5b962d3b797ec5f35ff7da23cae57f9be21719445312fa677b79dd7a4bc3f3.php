...
class __TwigTemplate_d11f4afe91c0559c42abc548b838ca8d33a0bb2546e727992a4566ea9029df4f extends Twig_SupTwgSgg_Template
{
...
($context["environment"] ?? null), "translate", array(0 => "Actions"), "method"));
        ...
        $context['_seq'] = Twig_SupTwgSgg_ensure_traversable(($context["columns"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["column"]) {
            // line 36
            echo "                                <th scope=\"col\">";
            echo Twig_SupTwgSgg_escape_filter($this->env, $context["column"], "html", null, true);
            echo "</th>";
        }
        ...
        // line 41
        $context['_parent'] = $context;
        $context['_seq'] = Twig_SupTwgSgg_ensure_traversable(($context["galleries"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["gallery"]) {
            // line 42
            echo "                        <tr id=\"gallery-";
            echo Twig_SupTwgSgg_escape_filter($this->env, $this->getAttribute($context["gallery"], "id", array()), "html", null, true);
            ...
            echo "
                            ...
                            <td>
                                <a href=\"";
            // line 50
            echo Twig_SupTwgSgg_escape_filter($this->env, $this->getAttribute(($context["environment"] ?? null), "generateUrl", array(0 => "galleries", 1 => "settings", 2 => array("gallery_id" => $this->getAttribute($context["gallery"], "id", array()))), "method"), "html", null, true);
            echo "\" data-toggle=\"tooltip\" title=\"";
            echo Twig_SupTwgSgg_escape_filter($this->env, sprintf($this->getAttribute(($context["environment"] ?? null), "translate", array(0 => "Edit gallery \"%s\""), "method"), $this->getAttribute($context["gallery"], "title", array())), "html", null, true);
            echo "\">";
            // line 51
            echo Twig_SupTwgSgg_title_string_filter($this->env, $this->getAttribute($context["gallery"], "title", array()));
            echo "
                                </a>
                            ...
                            <td>";
            // line 56
            if ((($this->getAttribute($context["gallery"], "attachment_id", array()) == 0) && (Twig_SupTwgSgg_length_filter($this->env, $this->getAttribute($context["gallery"], "link_default", array())) > 1))) {
                // line 57
            ...
            // line 62
            if ((Twig_SupTwgSgg_length_filter($this->env, ($context["cover"] ?? null)) < 1)) {
                // line 63
                if ((Twig_SupTwgSgg_length_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute($context["gallery"], "settings", array()), "posts", array()), "postCover", array())) > 1)) {
                    // line 64
            ...
            echo "                                <div style=\"width:155px;height:100px;overflow:hidden;\">
                                    <img src=\"";
            // line 68
            echo Twig_SupTwgSgg_escape_filter($this->env, ((array_key_exists("cover", $context)) ? (_Twig_SupTwgSgg_default_filter(($context["cover"] ?? null), ("holder.js/350x220?theme=gray&text=" . $this->getAttribute($context["gallery"], "title", array())))) : (("holder.js/350x220?theme=gray&text=" . $this->getAttribute($context["gallery"], "title", array())))), "html", null, true);
            echo "\" alt=\"";
            ...
            echo "\" class=\"ggCopyTextCode phpcode\"
                                       value=\"";
            // line 76
            echo Twig_SupTwgSgg_escape_filter($this->env, (("<?php echo do_shortcode('[supsystic-gallery id=" . $this->getAttribute($context["gallery"], "id", array())) . "]') ?>"), "html", null, true);
            echo "\">
                            </td>
                            <td>
                                <a href=\"";
            ...
            echo "
                                ...
                                <a href=\"";
            // line 84
            echo Twig_SupTwgSgg_escape_filter($this->env, $this->getAttribute(($context["environment"] ?? null), "generateUrl", array(0 => "galleries", 1 => "view", 2 => array("gallery_id" => $this->getAttribute($context["gallery"], "id", array()))), "method"), "html", null, true);
            echo "\"
                                   class=\"button background sggActionButtons\">
            ...
            echo "
                                ...
                                <a href=\"";
            // line 89
            echo Twig_SupTwgSgg_escape_filter($this->env, $this->getAttribute(($context["environment"] ?? null), "generateUrl", array(0 => "galleries", 1 => "preview", 2 => array("gallery_id" => $this->getAttribute($context["gallery"], "id", array()))), "method"), "html", null, true);
            echo "\"
                                   class=\"button background sggActionButtons\">
                                    <i class=\"fa fa-eye\"></i>";
            // line 92
            ...
            // line 100
            echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Are you sure you want to delete this gallery?")), "html", null, true);
            echo "\" class=\"button button-primary sggActionButtons\" title=\"Delete this gallery\"
                                   href=\"";
            // line 101
            echo Twig_SupTwgSgg_escape_filter($this->env, $this->getAttribute(($context["environment"] ?? null), "generateUrl", array(0 => "galleries", 1 => "delete", 2 => array("gallery_id" => $this->getAttribute($context["gallery"], "id", array()), "_wpnonce" => ($context["_wpnonce"] ?? null))), "method"), "html", null, true);
            echo "\">
                                    <i class=\"fa fa-trash-o\"></i>";
            // line 103
            echo Twig_SupTwgSgg_escape_filter($this->env, call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Delete gallery")), "html", null, true);
            echo "
                                </a>";
            // line 111
            echo "                            </td>
        ...
        // line 120
        echo Twig_SupTwgSgg_escape_filter($this->env, $this->getAttribute(($context["environment"] ?? null), "translate", array(0 => "Delete selected"), "method"), "html", null, true);
        echo "
                </button>
            </div>
        </div>
...
\t</div>";
    ...
    {
        return new Twig_SupTwgSgg_Source("", "@galleries/index.twig", "/Applications/MAMP/htdocs/Hexing/wp-content/plugins/gallery-by-supsystic/src/GridGallery/Galleries/views/index.twig");
    }
}
